...
?>
    <div class="container"  style='margin-top:70px;'>
        <div class="row">
            <div class="col-lg-12">
				 <h3 class=" text-danger">Need Blood To Save Life</h3>
				 <hr>
            </div>
        </div>
		    ...
		    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
                <div class="panel panel-danger">
                    <div class="panel-heading">
                        <h3 class="panel-title text-center" style="padding:5px;font-size:16px;font-weight:bold"> Need Blood To Save Lifes</h3>
                    </div>
					...
					<?php
						if(isset($_POST["submit"]))
						{
								...
								else
								{
								 ...
								 $sql="INSERT INTO request_blood(NAME,GENDER,BLOOD,BUNIT,HOSP,DISTRICT,POST_CODE,DOC,RDATE,CNAME,EMAIL,CON1,CON2,REASON,PIC,CADDRESS)
								 VALUES('{$_POST["NAME"]}','{$_POST["GENDER"]}','{$_POST["BLOOD"]}','{$_POST["BUNIT"]}','{$_POST["HOSP"]}','{$_POST["DISTRICT"]}','{$_POST["POST_CODE"]}','{$_POST["DOC"]}','{$_POST["RDATE"]}','{$_POST["CNAME"]}','{$_POST["EMAIL"]}','{$_POST["CON1"]}','{$_POST["CON2"]}','{$_POST["REASON"]}','{$target_file}','{$_POST["CADDRESS"]}')";
									if($con->query($sql))
									{
					...
					<form autocomplete="off" method="post"  action="<?php echo $_SERVER['PHP_SELF'];?>" enctype="multipart/form-data">
						<div class="form-group">
							<label class="control-label text-danger">Patient Name</label>
						...
						<div class="form-group">
						 ...
						 <div class="form-group">
								<label class="control-label text-danger">Need Unit Of Blood</label>
                                <input type="text" required name="BUNIT" id="BUNIT" class="form-control" placeholder="Insert No Of Unit">
                          </div>
						<div class="form-group">
								<label class="control-label text-danger">Hospital Name &amp; Address</label>
						...
						<div class="form-group">
						  	...
						  	<div class="form-group">
							<label class="control-label text-danger" >Upload Photo</label>
							<input type="file"  onChange="validate(this.value)" name="PIC" id="PIC">
						  </div>
						  
						  
						   <div class="form-group">
							<button class="btn btn-success" id="BTN" name="submit"> Request</button>
						  </div>
						 </form>
                    </div>
                </div>
