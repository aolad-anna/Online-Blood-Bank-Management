			...
			if($row['STATUS']=='1')
			{
				echo '<li class="list-group-item active">
						...
						<span   class="pull-right">
							<i>'.$row['LOGS'].'</i>&nbsp;
							<a href="view_mess.php?id='.$row['ID'].'" class="btn btn-success  btn-xs">View</a>
...
"></i> '.$row["NAME"].'</b>: '.substr($row["MESSAGE"],0,50).'....
						...
						<span   class="pull-right">
							<i>'.$row['LOGS'].'</i>&nbsp;
							<a href="view_mess.php?id='.$row['ID'].'" class="btn btn-danger btn-xs">View</a>
							<a href="admin_mess_del.php?id='.$row['ID'].'"  class="btn btn-danger btn-xs">Delete</a>
						</span>
				</li>';
			}
